...
public class PersonService {
  ...
  public interface Iface {
    ...
    public Person getPersonByUserName(java.lang.String username) throws DataExeption, org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Person recv_getPersonByUserName() throws DataExeption, org.apache.thrift.TException
    {
    ...
    public void recv_savePerson() throws DataExeption, org.apache.thrift.TException
    {
      savePerson_result result = new savePerson_result();
      receiveBase(result, "savePerson");
      if (result.dataExeptiont != null) {
        throw result.dataExeptiont;
      }
      return;
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getPersonByUserName_call extends org.apache.thrift.async.TAsyncMethodCall<Person> {
      ...
      public Person getResult() throws DataExeption, org.apache.thrift.TException {
    ...
    public static class savePerson_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public Void getResult() throws DataExeption, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class savePerson<I extends Iface> extends org.apache.thrift.ProcessFunction<I, savePerson_args> {
      ...
      public savePerson_result getResult(I iface, savePerson_args args) throws org.apache.thrift.TException {
        ...
        } catch (DataExeption dataExeptiont) {
          result.dataExeptiont = dataExeptiont;
        }
        return result;
      }
    }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<Person> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Person>() { 
          ...
          public void onError(java.lang.Exception e) {
            ...
            getPersonByUserName_result result = new getPersonByUserName_result();
            if (e instanceof DataExeption) {
              result.dataExeption = (DataExeption) e;
      ...
      public org.apache.thrift.async.AsyncMethodCallback<Void> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Void>() { 
          ...
          public void onError(java.lang.Exception e) {
            ...
            savePerson_result result = new savePerson_result();
            if (e instanceof DataExeption) {
              result.dataExeptiont = (DataExeption) e;
              result.setDataExeptiontIsSet(true);
              msg = result;
            } else if (e instanceof org.apache.thrift.transport.TTransportException) {
              _LOGGER.error("TTransportException inside handler", e);
              fb.close();
  ...
  public static class getPersonByUserName_result implements org.apache.thrift.TBase<getPersonByUserName_result, getPersonByUserName_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPersonByUserName_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable DataExeption dataExeption; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.DATA_EXEPTION, new org.apache.thrift.meta_data.FieldMetaData("dataExeption", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, DataExeption.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public getPersonByUserName_result(getPersonByUserName_result other) {
      ...
      if (other.isSetDataExeption()) {
        this.dataExeption = new DataExeption(other.dataExeption);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public DataExeption getDataExeption() {
      return this.dataExeption;
    }

    public getPersonByUserName_result setDataExeption(@org.apache.thrift.annotation.Nullable DataExeption dataExeption) {
      this.dataExeption = dataExeption;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case DATA_EXEPTION:
        if (value == null) {
          ...
          setDataExeption((DataExeption)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getPersonByUserName_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 1: // DATA_EXEPTION
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataExeption = new DataExeption();
  ...
  public static class savePerson_result implements org.apache.thrift.TBase<savePerson_result, savePerson_result._Fields>, java.io.Serializable, Cloneable, Comparable<savePerson_result>   {
    ...
    private static final org.apache.thrift.protocol.TField DATA_EXEPTIONT_FIELD_DESC = new org.apache.thrift.protocol.TField("dataExeptiont", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public @org.apache.thrift.annotation.Nullable DataExeption dataExeptiont; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      DATA_EXEPTIONT((short)1, "dataExeptiont");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 1: // DATA_EXEPTIONT
            return DATA_EXEPTIONT;
          default:
            return null;
        }
      }
    ...
    static {
      java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.DATA_EXEPTIONT, new org.apache.thrift.meta_data.FieldMetaData("dataExeptiont", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, DataExeption.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public savePerson_result(
      DataExeption dataExeptiont)
    {
      this();
      this.dataExeptiont = dataExeptiont;
    }
    ...
    public savePerson_result(savePerson_result other) {
      if (other.isSetDataExeptiont()) {
        this.dataExeptiont = new DataExeption(other.dataExeptiont);
      }
    }
    ...
    @Override
    public void clear() {
      this.dataExeptiont = null;
    }

    @org.apache.thrift.annotation.Nullable
    public DataExeption getDataExeptiont() {
      return this.dataExeptiont;
    }

    public savePerson_result setDataExeptiont(@org.apache.thrift.annotation.Nullable DataExeption dataExeptiont) {
      this.dataExeptiont = dataExeptiont;
      return this;
    }

    public void unsetDataExeptiont() {
      this.dataExeptiont = null;
    }

    /** Returns true if field dataExeptiont is set (has been assigned a value) and false otherwise */
    public boolean isSetDataExeptiont() {
      return this.dataExeptiont != null;
    }

    public void setDataExeptiontIsSet(boolean value) {
      if (!value) {
        this.dataExeptiont = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case DATA_EXEPTIONT:
        if (value == null) {
          ...
          setDataExeptiont((DataExeption)value);
        }
        break;
    ...
    public boolean equals(savePerson_result that) {
      ...
      boolean this_present_dataExeptiont = true && this.isSetDataExeptiont();
      boolean that_present_dataExeptiont = true && that.isSetDataExeptiont();
      if (this_present_dataExeptiont || that_present_dataExeptiont) {
        if (!(this_present_dataExeptiont && that_present_dataExeptiont))
          return false;
        if (!this.dataExeptiont.equals(that.dataExeptiont))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetDataExeptiont()) ? 131071 : 524287);
      if (isSetDataExeptiont())
        hashCode = hashCode * 8191 + dataExeptiont.hashCode();
    ...
    public int compareTo(savePerson_result other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetDataExeptiont()).compareTo(other.isSetDataExeptiont());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDataExeptiont()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataExeptiont, other.dataExeptiont);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public java.lang.String toString() {
      ...
      sb.append("dataExeptiont:");
      if (this.dataExeptiont == null) {
        sb.append("null");
      } else {
        sb.append(this.dataExeptiont);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class savePerson_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<savePerson_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, savePerson_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // DATA_EXEPTIONT
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataExeptiont = new DataExeption();
                struct.dataExeptiont.read(iprot);
                struct.setDataExeptiontIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, savePerson_result struct) throws org.apache.thrift.TException {
        ...
        oprot.writeStructBegin(STRUCT_DESC);
        if (struct.dataExeptiont != null) {
          oprot.writeFieldBegin(DATA_EXEPTIONT_FIELD_DESC);
          struct.dataExeptiont.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
